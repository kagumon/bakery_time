            ...
            return SafeArea(
              child: Column(
                children: [
                  ...
                  Stack(
                    children: [
                      ...
                      CircularPercentIndicator(
                        ...
                        percent: provider.isFinish || bakeryTimer.targetTime <= 0 ? 1.0 : (bakeryTimer.targetTime - bakeryTimer.timerTime) / bakeryTimer.targetTime,
                        circularStrokeCap: CircularStrokeCap.butt,
                        progressColor: provider.isFinish ? indicatorFinishColor : indicatorActiveColor,
                  ...
                  Center(
                    child: Text(
                        secondFormatHHMMSS((bakeryTimer.targetTime - bakeryTimer.timerTime).floor()),
                        style: TextStyle(
